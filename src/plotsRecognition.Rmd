...
exp1_data <- read_csv(file = file.path(data_path, "raw_data", "exp_1.csv"))
# original name: L:/2_Research/2_Analysis_Folder/MemVio//part3_RTout.csv"

exp2_data <- read_csv(file = file.path(data_path, "raw_data", "exp_2.csv"))
...
df <- bind_rows(exp1_data, exp2_data)
